      ...
      <Fade bottom>
        <Accordion sx={{ paddingLeft: 2, paddingRight: 2, margin: '0 auto' }}>
          ...
          <AccordionDetails sx={{ margin: '0 auto', padding: '20px' }}>
            <CourseInfo>
              10+ hour course (in the comfort of your own home or online).
              <br />
              Weekly sessions, topics will cover everything from the science of
              birth, how your brain affects everything, your birth plans, your
              birth environment to learning the importance of your birth
              partner!
            </CourseInfo>
          </AccordionDetails>
        </Accordion>
        <Accordion sx={{ paddingLeft: 2, paddingRight: 2, margin: '0 auto' }}>
          ...
          <AccordionDetails
            sx={{ width: '75%', margin: '0 auto', padding: '20px' }}
          >
            <CourseInfo>
              Private 4 hour course (Online).
              <br />
              This is the ideal course if you are close to your due date or just
              want to refresh your memory!
              <br />
              <br />
              Here are just some of the things the course covers!
              <br />
              <br />
        ...
        <Accordion sx={{ paddingLeft: 2, paddingRight: 2, margin: '0 auto' }}>
          ...
          <AccordionDetails sx={{ margin: '0 auto', padding: '20px' }}>
            <CourseInfo>1 hour call to discuss any topic you like!</CourseInfo>
          </AccordionDetails>
        </Accordion>
        <Accordion disabled sx={{ margin: '0 auto' }}>
          ...
          >
            ...
            >
              Full Group Online Course (COMING SOON)
            </Typography>
          </AccordionSummary>
        </Accordion>
        <Accordion disabled sx={{ margin: '0 auto', marginBottom: "100px" }}>
          ...
          >
            ...
            >
              Full Group Face-to-Face Course (COMING SOON)
            </Typography>
          </AccordionSummary>
        </Accordion>
      </Fade>
